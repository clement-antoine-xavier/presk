...
import { UserAvatar } from '@/components/friends/person-avatar';
...
import { ConversationParticipant } from '@/components/friends/types';

type ConversationSettingsFormValues = {
  title: string;
};

function ConversationSettings({ theme }: { theme: MD3Theme }) {
...
export default withTheme(ConversationSettings);
